...
from filecontroller import fileexplorer
...
class Lexer:
    ...
    # lex() 메소드는 입력 문자열을 토큰화 하여 토큰(Token)들의 리스트를 반환
    ...
    def peek2(self) -> str:
        return None if self.is_end() or self.current + 1 >= len(self.source) else self.source[
